...
export default class TheTeam extends Component {
  ...
  showPlayersByCategeory = category =>
    this.state.players
          ...
          <div>
            <div className="team_category_wrapper">
              ...
              <div className="team_cards">
                {this.showPlayersByCategeory("Keeper")}
              </div>
            </div>
            ...
            <div className="team_category_wrapper">
              ...
              <div className="team_cards">
                {this.showPlayersByCategeory("Defence")}
              </div>
            </div>
            ...
            <div className="team_category_wrapper">
              ...
              <div className="team_cards">
                {this.showPlayersByCategeory("Midfield")}
              </div>
            </div>
            ...
            <div className="team_category_wrapper">
              ...
              <div className="team_cards">
                {this.showPlayersByCategeory("Striker")}
              </div>
            </div>
          </div>
        ) : null}
